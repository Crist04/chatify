      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ButtonComponent(buttonColor:Colors.lightBlueAccent, buttonText:'Log In', onPressed: () {
              Navigator.pushNamed(context,LoginScreen.id);
            },),
            ButtonComponent(buttonColor: Colors.blueAccent, buttonText: 'Register', onPressed: () {
